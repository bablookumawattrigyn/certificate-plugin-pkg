...
var r = /* @__PURE__ */ t(((e, t) => {
	...
	if (j && (L = function(e) {
		...
		return r.parent = !0, i.ok = p(e) ? e : !0, i.fail = p(t) && t, i.domain = n ? te.domain : void 0, r.state === oe ? r.reactions.add(i) : b(function() {
			_e(i, r);
		}), i.promise;
	}), me = function() {
		var e = new pe(), t = P(e);
	...
	var n = s(), r = E(), i = B(), a = T(), o = ot(), c = TypeError;
	t.exports = function(e, t) {
...
//# sourceMappingURL=index.es-wgaX2niW.js.map